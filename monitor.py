...
#
#if session is None:
#    print 'Login failed.  Bailing'
#    os.sys.exit(1)
#
#print 'Login successful'
#
#req = session.get('http://forums.overclockers.com.au/printthread.php?t=1025975&pp=1')
#open('foo2.html', 'w+').write(req.text.encode('utf-8'))
#
##soup = BeautifulSoup(req.text)
##open('foo.html', 'w+').write(soup.prettify().encode('utf-8'))
#
#print 'done'
#
#
# soup = BeautifulSoup(open('foo2.html', 'r').read())
#print soup.prettify()
# print get_post(soup)
#
# req = requests.get('http://forums.overclockers.com.au/forumdisplay.php?f=15')
# soup = BeautifulSoup(req.text)
# print soup.prettify()
#
#
...
#
#
#db.update_post(Post(2, 15, '2011-01-23 21:12:12', 'Billy Bob', 'Buying Shit', 'post'))
#
#for post in db.get_posts(id_forum=15, limit=10):
#    print post
